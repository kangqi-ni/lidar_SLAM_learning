...
void ReadPoseInformation(const std::string path, std::vector<Eigen::Vector3d> &poses)
{
    ...
    std::cout << "Read Pose Succceeded!!!" << std::endl;
}
                              ...
                              std::vector<GeneralLaserScan> &laserscans)
{
    ...
    std::cout << "Read Angle Succeeded:" << tmpGeneralLaserScan.angle_readings.size() << std::endl;
    ...
    std::cout << "Read Laser Scans Succeeded!!!!" << std::endl;
}
