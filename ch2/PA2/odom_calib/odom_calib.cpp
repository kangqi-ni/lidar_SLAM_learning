...
int main(int argc, char** argv)
{
    ...
    // 进行最小二乘求解
    Eigen::Vector2d J21J22 = A.colPivHouseholderQr().solve(b);
    ...
    Eigen::Matrix<double,1,1> D = C.colPivHouseholderQr().solve(S);

    double b_wheel = D[0];
    double r_L = -J21 * b_wheel;
    double r_R = J22 * b_wheel;
